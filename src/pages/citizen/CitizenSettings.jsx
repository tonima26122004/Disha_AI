            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-4 sm:gap-6">
                ...
                <motion.div
                  ...
                  className="md:col-span-2 lg:col-span-8 bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl shadow-lg border border-blue-200 overflow-hidden"
                >
                ...
                <motion.div
                  ...
                  className="md:col-span-2 lg:col-span-4 bg-gradient-to-br from-green-50 to-green-100 rounded-2xl shadow-lg border border-green-200 overflow-hidden"
                >
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <button
                          ...
                          className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                            settings.emergencyAlerts ? 'bg-green-600' : 'bg-gray-200'
                          }`}
                        >
                          <span
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <button
                            ...
                            className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                              settings.aiSuggestions ? 'bg-purple-600' : 'bg-gray-200'
                            }`}
                          >
                            <span
                              className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                                settings.aiSuggestions ? 'translate-x-6' : 'translate-x-1'
                              }`}
                            />
                          </button>
                        </div>
